...
namespace TownOfUs.CustomOption
{
    public class Generate
    {
        ...
        public static CustomNumberOption ExploderOn;
        ...
        public static CustomHeaderOption Exploder;
        public static CustomNumberOption ExplodeCooldown;
        public static CustomNumberOption ExplodeDuration;
        public static CustomToggleOption ExploderVent;
        ...
        public static void GenerateAll()
        {
            ...
            PoisonerOn = new CustomNumberOption(true, num++, "<color=#FF0000FF>Poisoner</color>", 0f, 0f, 100f, 10f,
                PercentFormat);
            ExploderOn = new CustomNumberOption(true, num++, "<color=#FF0000FF>Exploder</color>", 0f, 0f, 100f, 10f,
                PercentFormat);
            ...
            Exploder =
                new CustomHeaderOption(num++, "<color=#FF0000FF>Exploder</color>");
            PoisonCooldown =
                new CustomNumberOption(num++, "Explode Cooldown", 25, 10, 40, 2.5f, CooldownFormat);
            PoisonDuration =
                new CustomNumberOption(num++, "Explode Kill Delay", 5, 1, 15, 1f, CooldownFormat);
            PoisonerVent =
                new CustomToggleOption(num++, "Exploder Can Vent", false);
