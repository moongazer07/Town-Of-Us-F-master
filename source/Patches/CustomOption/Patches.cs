...
namespace TownOfUs.CustomOption
{
    public static class Patches
    {
        ...
        private class OptionsMenuBehaviour_Start
        {
            public static void Postfix(GameSettingMenu __instance)
            {
                ...
                if (title != null)
                {
                    ...
                    title.GetComponent<TMPro.TextMeshPro>().m_text = "Town Of Sus Settings";
                }
                var sliderInner = gameGroup?.FindChild("SliderInner");
                if (sliderInner != null)
                    sliderInner.GetComponent<GameOptionsMenu>().name = "TosGameOptionsMenu";
        ...
        private class GameOptionsMenu_Start
        {
            ...
            {
                if (__instance.name != "TosGameOptionsMenu")
                    return true;
