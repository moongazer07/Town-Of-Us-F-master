...
namespace TownOfUs
{
    [BepInPlugin(Id, "Town Of SUS", VersionString)]
    [BepInDependency(ReactorPlugin.Id)]
    [BepInDependency(SubmergedCompatibility.SUBMERGED_GUID, BepInDependency.DependencyFlags.SoftDependency)]
    public class TownOfUs : BasePlugin
    {
        public const string Id = "com.moongazer07.townofsus";
        ...
        public static Sprite ExplodedSprite;
        ...
        public override void Load()
        {
            ...
            _harmony = new Harmony("com.moongazer07.townofus");
            ...
            ExplodeSprite = CreateSprite("TownOfUs.Resources.Explode.png");
            ExploderSprite = CreateSprite("TownOfUs.Resources.Exploded.png");
